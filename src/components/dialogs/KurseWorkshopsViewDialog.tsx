  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Kurse & Workshops anzeigen</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Uhrzeit Beginn</Label>
            <p className="text-sm">{record.fields.uhrzeit_beginn ?? '—'}</p>
          </div>
          <div className="space-y-1">
            <Label className="text-xs text-muted-foreground">Uhrzeit Ende</Label>
          ...
          <div className="space-y-1">
            ...
            <Badge variant="secondary">{record.fields.status_kurs?.label ?? '—'}</Badge>
          </div>
