  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'notfall_name': (
      <div key="notfall_name" className="space-y-1.5">
        <Label htmlFor="notfall_name">Name Notfallkontakt</Label>
        <Input
          id="notfall_name"
    ...
    'notfall_telefon': (
      <div key="notfall_telefon" className="space-y-1.5">
        <Label htmlFor="notfall_telefon">Telefon Notfallkontakt</Label>
        <Input
          id="notfall_telefon"
    ...
    'bemerkungen_tn': (
      <div key="bemerkungen_tn" className="space-y-1.5">
        <Label htmlFor="bemerkungen_tn">Bemerkungen</Label>
        <Textarea
          id="bemerkungen_tn"
